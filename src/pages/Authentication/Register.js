...
import img from "./Code Players.jpg";
...
const Register = () => {
    ...
    document.title = "Vendor X - Sign up page";
                                ...
                                <div className="text-center mt-sm-5 mb-4 text-white-50">
                                    <div>
                                        <Link to="/" className="d-inline-block auth-logo">
                                            <img src={img} alt="" height="150" width="250" />
                                        </Link>
                                    </div>
                                    <p className="mt-3 fs-15 fw-medium">Your perfect solution for business automation</p>
                                </div>
                            </Col>
                        </Row>
                                ...
                                <Card className="mt-4">
                                    ...
                                    <CardBody className="p-4">
                                        <div className="text-center mt-2">
                                            ...
                                            <p className="text-muted">Get your free Vendor X account now</p>
                                        </div>
                                        <div className="p-2 mt-4">
                                            <Form
                                                ...
                                                <div className="mb-4">
                                                    <p className="mb-0 fs-12 text-muted fst-italic">By registering you agree to the Code Players
